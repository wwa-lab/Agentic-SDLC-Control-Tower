...
import { type TriageQueue, queueForStatus } from '../utils/controlPlane';
  ...
  <div class="list-view">
    ...
    <section class="workbench-header">
      ...
      <div class="workbench-actions">
        <button class="primary-btn" type="button" @click="importStore.openImport()">
          <Sparkles :size="15" />
    ...
    <div v-else-if="visibleRequirements.length === 0" class="empty-state">
      ...
      <button class="primary-btn" type="button" @click="importStore.openImport()">New Requirement</button>
    </div>
    ...
    <RequirementKanbanBoard
      v-else-if="store.viewMode === 'kanban'"
      :requirements="visibleRequirements"
      :control-plane-summaries="store.controlPlaneSummaries"
      @select="handleSelect"
    />
