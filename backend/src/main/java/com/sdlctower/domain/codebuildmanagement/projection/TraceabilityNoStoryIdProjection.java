...
@Component("codeBuildManagementTraceabilityNoStoryIdProjection")
public class TraceabilityNoStoryIdProjection {
    ...
    public TraceabilityNoStoryIdProjection(
    ...
    public List<TraceabilityCommitRefDto> load(String workspaceId) {
        List<CommitStoryLinkEntity> links = commitStoryLinkRepository
                .findByLinkStatus("NO_STORY_ID", PageRequest.of(0, 100));
